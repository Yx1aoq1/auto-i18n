...
export class File {
  ...
  static async write(filepath: string, data: string, opts?: FileEncoding) {
  ...
  static writeSync(filepath: string, data: string, opts?: FileEncoding) {
    const { encoding, bom } = opts || this.__getFileEncoding(filepath)
  ...
  static getExtname(filepath: string) {
  ...
  static deleteSync(filepath: string) {
